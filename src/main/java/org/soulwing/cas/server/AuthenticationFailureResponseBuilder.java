...
/**
 * A builder for an unsuccessful authentication response.
 *
 * @author Carl Harris
 */
public interface AuthenticationFailureResponseBuilder 
   ...
   * @return this builder
   */
  AuthenticationFailureResponseBuilder message(String message);
